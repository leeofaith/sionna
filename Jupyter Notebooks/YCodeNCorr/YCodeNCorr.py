...
from PlotYCodeNCorr import plotycodencorr
...
class ycodencorr(Model): # Inherits from Keras Model
    def __init__(self,
                 Block_Length,
                 NUM_BITS_PER_SYMBOL,
                 CONSTELLATION_TYPE,
    ...
    def __call__(self,
        ...
        ##    Coded
        plt.figure()
        title = "SER: Coding & No Sptatial Correlation"
        xlabel = "$E_b/N_0$ (dB)"
        ylabel = "SER (log)"
        plt.title(title, fontsize=12)
        plt.xticks(fontsize=10)
        ...
        ##    Coded
        plt.figure()
        title = "BER: Coding & No Sptatial Correlation"
        xlabel = "$E_b/N_0$ (dB)"
        ylabel = "BER (log)"
        plt.title(title, fontsize=12)
        plt.xticks(fontsize=10)
