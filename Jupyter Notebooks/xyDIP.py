...
class DeepImagePrior(object):
    ...
    def DIP(self,Y,H):
        ...
        x_dip_ay = np.empty((batch_size,4)) # Tx: 4
        num_stop_point = []
        ...
        for bs in range(batch_size):
            ...
            H_torch = torch.from_numpy((H[bs]).numpy()).reshape(1, 1, self.user_num, 4).type(dtype) # Tx: 4
            ...
            while i < self.iteration and flag==False :
                ...
                out1 = out.reshape(1,1,8,1).type(dtype) # Tx * Block Length=(4)*(2)
                ...
                # print('x_dip0 shape =', x_dip.shape)
                # print('x_dip =', x_dip)
                if  self.stop is True:
                    ...
                    if cur_var != 0 and cur_var <  self.threshold:
                        ...
                        flag = True                
            # print('x_dip1 shape =', x_dip.shape)
            # print('x_dip1 =', x_dip)            
...
class Decoder(nn.Module):
    def __init__(self,user_num):
        ...
        self.nn4 = nn.Linear(32,8) # # Tx * Block Length=(4)*(2)
