...
from NocodingPlotFigure import NocodingPlotFigure
...
class NoncodingFlatFadingSpatial(Model): # Inherits from Keras Model
    def __init__(self,
                 Block_Length,
                 NUM_BITS_PER_SYMBOL,
                 CONSTELLATION_TYPE,
    ...
    def __call__(self,
        ...
        for TX_ANT_CORRELATION in np.linspace(self.CORRELATION_INDEX_MIN,
            ...
            for RX_ANT_CORRELATION in np.linspace(self.CORRELATION_INDEX_MIN,
                ...
                for i in range(0, NUM_DATA_GROUP):
                    ...
                    ##    Uncoded
                    plt.figure()
                    title = f"SER: Noncoding Corr(Tx{TX_ANT_CORRELATION},Rx{RX_ANT_CORRELATION}) Falt-Fading"
                    xlabel = "$E_b/N_0$ (dB)"
                    ylabel = "SER (log)"
                    ...
                    ##    Uncoded
                    plt.figure()
                    title = f"BER: Noncoding Corr({TX_ANT_CORRELATION},{RX_ANT_CORRELATION}) Falt-Fading"
                    xlabel = "$E_b/N_0$ (dB)"
                    ylabel = "BER (log)"
                    plt.title(title, fontsize=12)
                    plt.xticks(fontsize=10)
                    ...
                    plt.figure()
                    title = f"SER & BER: Noncoding Corr({TX_ANT_CORRELATION},{RX_ANT_CORRELATION}) Falt-Fading"
                    xlabel = "$E_b/N_0$ (dB)"
                    ylabel = "SER/BER (log)"
                    plt.title(title, fontsize=12)
                    plt.xticks(fontsize=10)
                    ...
                    NocodingPlotFigure(x=snrs, 
                                      ...
                                      y_label="SER/BER (log)",
                                      title=f"SER & BER: Noncoding Corr({TX_ANT_CORRELATION},{RX_ANT_CORRELATION}) Falt-Fading",
                                      filename=f"SER&BER-Noncoding FaltFading with Corr({TX_ANT_CORRELATION},{RX_ANT_CORRELATION}).html")
        ...
        ##  SER
        plt.figure()
        title = "SER: Noncoding Spatial-Correlation MIMO Through Falt-Fading"
        xlabel = "$E_b/N_0$ (dB)"
        ylabel = "SER (log)"
        plt.title(title, fontsize=12)
        plt.xticks(fontsize=10)
        ...
        ##  BER 
        plt.figure()
        title = "BER: Noncoding Spatial-Correlation MIMO Through Falt-Fading"
        xlabel = "$E_b/N_0$ (dB)"
        ylabel = "SER/BER (log)"
        plt.title(title, fontsize=12)
        plt.xticks(fontsize=10)
        ...
        ##  SER & BER
        plt.figure()
        title = "SER & BER: Noncoding Spatial-Correlation MIMO Through Falt-Fading"
        xlabel = "$E_b/N_0$ (dB)"
        ylabel = "SER/BER (log)"
        plt.title(title, fontsize=12)
        plt.xticks(fontsize=10)
