...
def NocodingPlotFigure(x, 
    ...
    p.line(x, y4, legend_label='ZF BER', line_color='purple')
    p.line(x, y5, legend_label='LMMSE BER', line_color='lightseagreen')
    p.line(x, y6, legend_label='DIP BER', line_color='gold')
