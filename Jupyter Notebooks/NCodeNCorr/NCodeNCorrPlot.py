...
def ncodencorrplot(x, 
    ...
    # 添加曲线
    p.line(x, y1, legend_label='ZF', line_color='blue', line_width=2)
    p.line(x, y2, legend_label='LMMSE', line_color='green', line_width=2)
    p.line(x, y3, legend_label='DIP', line_color='red', line_width=2)
